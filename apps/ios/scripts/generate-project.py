...
posthogPackage = add('posthog-package', {'isa':'XCRemoteSwiftPackageReference','repositoryURL':'https://github.com/PostHog/posthog-ios.git','requirement':{'kind':'exactVersion','version':'3.81.0'}})
posthogProduct = add('posthog-product', {'isa':'XCSwiftPackageProductDependency','package':posthogPackage,'productName':'PostHog'})
...
appTarget = add('app-target',{'isa':'PBXNativeTarget','buildConfigurationList':appConfigs,'buildPhases':[appSources,appFrameworks,resources],'buildRules':[],'dependencies':[],'packageProductDependencies':[posthogProduct],'name':'Freewrite','productName':'Freewrite','productReference':app,'productType':'com.apple.product-type.application'})
